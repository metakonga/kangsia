...
public:
	...
	sphydrodynamics* initialize()
	{
		...
		bottom_wall1->define(VEC3D(0.0f, 0.f, 0.f), VEC3D(0.4f, 0.f, 0.f), true, true);

		geo::line *bottom_wall2 = new geo::line(isph, BOUNDARY, "bottom_wall");
		bottom_wall2->define(VEC3D(0.45f, 0.f, 0.f), VEC3D(0.5f, 0.f, 0.f), true, true);
		...
		ob_left->define(VEC3D(0.4f, 0.0f, 0.0f), VEC3D(0.4f, 0.05f, 0.0f), true, false, true);
		ob_left->innerDefine(VEC3D(0.4f, 0.05f, 0.0f));

		geo::line *ob_top = new geo::line(isph, BOUNDARY, "ob_top");
		ob_top->define(VEC3D(0.4f, 0.05f, 0.0f), VEC3D(0.45f, 0.05f, 0.0f), true, false, true);
		ob_top->innerDefine(VEC3D(0.4f, 0.05f, 0.0f));
		ob_top->innerDefine(VEC3D(0.45f, 0.05f, 0.0f));

		geo::line *ob_right = new geo::line(isph, BOUNDARY, "ob_right");
		ob_right->define(VEC3D(0.45f, 0.05f, 0.0f), VEC3D(0.45f, 0.f, 0.f), true, false, true);
		ob_top->innerDefine(VEC3D(0.45f, 0.05f, 0.0f));
