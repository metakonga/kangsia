...
public:
	...
	sphydrodynamics* initialize()
	{
		...
		fluid_top->define(VEC3F(0.0f, 0.2025f, 0.f), VEC3F(0.1f, 0.2025f, 0.f), true);
		...
		bottom_wall->define(VEC3F(0.0f, 0.f, 0.f), VEC3F(0.4f, 0.f, 0.f), true, true);

		geo::line *left_wall = new geo::line(isph, BOUNDARY, "left wall");
		left_wall->define(VEC3F(0.0f, 0.8f, 0.f), VEC3F(0.0f, 0.0f, 0.0f), true);

		geo::line *right_wall = new geo::line(isph, BOUNDARY, "right wall");
		right_wall->define(VEC3F(0.4f, 0.0f, 0.f), VEC3F(0.4f, 0.8f, 0.f), true);
