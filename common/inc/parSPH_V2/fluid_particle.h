...
public:
	...
	void setVelocity(VEC3D& _vel) { vel = _vel; }
	void setAuxVelocity(VEC3D& _aux_vel) { aux_vel = _aux_vel; }
	void setNormal(VEC3D& _nor) { nor = _nor; }
	void setNormal2(VEC3D& _nor2) { nor2 = _nor2; }
	void setTangent(VEC3D& _tan) { tan = _tan; }
	...
	void setVelocityOld(VEC3D& _vel) { vel_old = _vel; }
	...
	void setViscousTerm(VEC3D _v) { viscous_t = _v; }
