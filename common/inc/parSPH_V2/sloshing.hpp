...
public:
	...
	sphydrodynamics* initialize()
	{
		...
		fluid_top->define(VEC3D(0.0f, 0.1025f, 0.f), VEC3D(0.5f, 0.1025f, 0.f), true);
		...
		left_wall->define(VEC3D(0.0f, 0.3f, 0.f), VEC3D(0.0f, 0.0f, 0.0f), true);
		...
		right_wall->define(VEC3D(0.5f, 0.0f, 0.f), VEC3D(0.5f, 0.3f, 0.f), true);
