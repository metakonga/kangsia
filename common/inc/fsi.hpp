...
public:
	...
	sphydrodynamics* initialize()
	{
		...
		//isph->setKernel(CUBIC_SPLINE, false, 0.013f);0000000000000000000000000000000000000
		...
		fluid_top->define(VEC3F(0.0f, 0.05f, 0.f), VEC3F(0.1f, 0.05f, 0.f), true);

 		geo::line *fluid_right = new geo::line(isph, FLUID, "fluid right");
 		fluid_right->define(VEC3F(0.04f, 0.05f, 0.f), VEC3F(0.04f, 0.0f, 0.f), true);

		geo::line *bottom_wall = new geo::line(isph, BOUNDARY, "bottom_wall");
		bottom_wall->define(VEC3F(0.0f, 0.f, 0.f), VEC3F(0.1f, 0.f, 0.f), true, true);

		geo::line *left_wall = new geo::line(isph, BOUNDARY, "left wall");
		left_wall->define(VEC3F(0.0f, 0.1f, 0.f), VEC3F(0.0f, 0.0f, 0.0f), true);
		...
		right_wall->define(VEC3F(0.1f, 0.0f, 0.f), VEC3F(0.1f, 0.1f, 0.f), true);
